...
public class HttpClientHelp {
    ...
    private static HttpClient wrapClient(String host, String path) {
        ...
        if (host != null && host.startsWith("https://")) {
            return sslClient();
        } else if (StringUtils.isEmpty(host) && path != null && path.startsWith("https://")) {
            return sslClient();
        }
        return httpClient;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            resp = EntityUtils.toString(response.getEntity(), Charsets.UTF_8);
        } catch (IOException e) {
            e.printStackTrace();
        }
